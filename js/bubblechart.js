...
window.onload = function(){
    ...
    //Example 1.9 line 1...innerRect block
    ...
    //above Example 2.8 line 20, set range and domain for x scale
    var x = d3.scaleLinear() //create the scale
        .range([90, 730]) //output min and max
        .domain([0, 3]); //input min and max

    //above Example 2.8 line 20, find the minimum value of the array
    ...
    //below Example 3.5; Example 3.6 line 1...create y axis generator
